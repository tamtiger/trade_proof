...
$matches = git grep --untracked -n -E $secretPattern -- . ':!.harnix/**' ':!docs/**' ':!README.md' ':!tools/test-phase0.ps1' ':!tools/test-phase1.ps1' ':!tools/test-phase2.ps1' ':!tools/test-phase3.ps1' ':!tools/test-phase4.ps1' ':!tools/verify-phase2.ps1' ':!tools/verify-phase3.ps1' ':!tools/verify-phase4.ps1' ':!**/bin/**' ':!**/obj/**'
...
Write-Host "Phase 4 local CI verification passed."
